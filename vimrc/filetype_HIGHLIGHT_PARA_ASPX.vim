...
" Added by JMC for ASPX and ASP:
au BufNewFile,BufRead *.aspx			setf cs
au BufNewFile,BufRead *.aspx.tpl			setf cs
au BufNewFile,BufRead *.asp			setf vb
au BufNewFile,BufRead *.asp.tpl			setf vb
