...
"Added by jmc: made the "RO" indicator actually red:
"      \ 'red': [ '#ffffff' , '' , 231 , '' , '' ],
...
"Added by jmc: Made inactive tabs a stronger grey. Made the blue tabs be the same blue in GUI:
"        \ 'airline_tab':      ['#343434', '#b3b3b3',  237, 250, ''],
"        \ 'airline_tabsel':   ['#ffffff', '#004b9a',  231, 31 , ''],
let g:airline#themes#sol#palette.tabline = {
      \ 'airline_tab':      ['#343434', '#949494',  237, 246, ''],
      \ 'airline_tabsel':   ['#ffffff', '#0087af',  231, 31 , ''],
